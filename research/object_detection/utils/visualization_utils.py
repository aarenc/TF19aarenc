...
def visualize_boxes_and_labels_on_image_array(
  ...
  print(dict)
  with open("../temporal.csv", "a") as temporalcsv:
    temporal_diario = csv.writer(temporalcsv, delimiter=",", lineterminator="\n")
    temporal_diario.writerow([dict])
